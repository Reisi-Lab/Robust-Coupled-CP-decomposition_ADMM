function [Objective_value,Outp1,Outp2] = lagrange_function(X,Y,A,V,F,S1,M,S2,D1,D2,opts)
...
%
%      Output:
%          Objective_value: objective value of original function
